...
-- Dumping data for table joomla_virgin.virgin_redirect_links: ~3 rows (approximately)
/*!40000 ALTER TABLE `virgin_redirect_links` DISABLE KEYS */;
INSERT INTO `virgin_redirect_links` (`id`, `old_url`, `new_url`, `referer`, `comment`, `hits`, `published`, `created_date`, `modified_date`, `header`) VALUES
...
/*!40000 ALTER TABLE `virgin_redirect_links` ENABLE KEYS */;

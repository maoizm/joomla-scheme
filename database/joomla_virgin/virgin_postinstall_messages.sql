...
-- Dumping data for table joomla_virgin.virgin_postinstall_messages: ~4 rows (approximately)
/*!40000 ALTER TABLE `virgin_postinstall_messages` DISABLE KEYS */;
INSERT INTO `virgin_postinstall_messages` (`postinstall_message_id`, `extension_id`, `title_key`, `description_key`, `action_key`, `language_extension`, `language_client_id`, `type`, `action_file`, `action`, `condition_file`, `condition_method`, `version_introduced`, `enabled`) VALUES
...
/*!40000 ALTER TABLE `virgin_postinstall_messages` ENABLE KEYS */;

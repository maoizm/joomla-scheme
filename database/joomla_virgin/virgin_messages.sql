...
-- Dumping data for table joomla_virgin.virgin_messages: ~1 rows (approximately)
/*!40000 ALTER TABLE `virgin_messages` DISABLE KEYS */;
INSERT INTO `virgin_messages` (`message_id`, `user_id_from`, `user_id_to`, `folder_id`, `date_time`, `state`, `priority`, `subject`, `message`) VALUES
...
/*!40000 ALTER TABLE `virgin_messages` ENABLE KEYS */;

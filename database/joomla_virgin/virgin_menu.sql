...
-- Dumping data for table joomla_virgin.virgin_menu: ~21 rows (approximately)
/*!40000 ALTER TABLE `virgin_menu` DISABLE KEYS */;
INSERT INTO `virgin_menu` (`id`, `menutype`, `title`, `alias`, `note`, `path`, `link`, `type`, `published`, `parent_id`, `level`, `component_id`, `checked_out`, `checked_out_time`, `browserNav`, `access`, `img`, `template_style_id`, `params`, `lft`, `rgt`, `home`, `language`, `client_id`) VALUES
...
/*!40000 ALTER TABLE `virgin_menu` ENABLE KEYS */;

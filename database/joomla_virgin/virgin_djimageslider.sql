...
-- Dumping data for table joomla_virgin.virgin_djimageslider: ~7 rows (approximately)
/*!40000 ALTER TABLE `virgin_djimageslider` DISABLE KEYS */;
INSERT INTO `virgin_djimageslider` (`id`, `catid`, `title`, `alias`, `image`, `description`, `published`, `publish_up`, `publish_down`, `checked_out`, `checked_out_time`, `ordering`, `params`) VALUES
...
/*!40000 ALTER TABLE `virgin_djimageslider` ENABLE KEYS */;
